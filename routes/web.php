...
#rutas/
/*Route::get('/categorias','CategoryController')->name(admin.categories.index)*/
//parte administrativa por categoriasUndefined variable: tags (View: /home/erick/public_html/bloglaravel/resources/views/admin/tags/edit.blade.php)
