...
<div class="card">
  ...
  <div class="card-body">
    <form class="" action="{{route('admin.countries.update',[$country->id])}}" method="post" name="formCountry" id="formCountry">

      <div class="form-group">
        <label for="name" class="control-label">Nombre  <span class="text-danger">*</span></label>
        <input type="text" name="name" id="name" value="{{ $country->name }}" class="form-control" placeholder="Introduzca un Nombre" required>
      </div >
      <div class="row">
        <div class="col-md-6">
          <label for="code" class="control-lavel">Hashtag <span class="text-fanger">*</span> </label>
          <input type="text" name="code" id="code" value="{{ $country->code}}" class="form-control" placeholder="Introduzca un codigo" required>
        </div>
        <div class="col-md-6">
