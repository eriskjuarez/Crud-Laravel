<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="#">quejateya!!</a>
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="{{route('admin.posts.index')}}">publicaciones</a>
          ...
          <a class="dropdown-item" href="{{route('admin.tags.index')}}">Etiquetas</a>
