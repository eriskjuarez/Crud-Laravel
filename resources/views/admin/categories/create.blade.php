...
<div class="card">
  ...
  <div class="card-body">
    <form class="" action="{{route('admin.categories.store')}}" method="post" name="formCategory" id="formCategory">
...
<div class="row">
  <div class="col-md-6">
    ...
    <input type="text" name="hashtag" id="hashtag" value="" class="form-control" placeholder="Introduzca un Hashtag" required>
  </div>
  <div class="col-md-6">
